...
//		    bias1 = randGen.NextDouble();
//		    bias2 = randGen.NextDouble();
//
...
//		    }
//		    bias1 = double.Parse(lines[i+1]);
//		    bias2 = double.Parse(lines[i+2]);
//
//			XmlDocument settings = new XmlDocument ();
//			settings.Load(settingsFile);
//
...
//		        writer.WriteLine(value);
//		    writer.WriteLine(bias1);
//		    writer.WriteLine(bias2);
//		    writer.Close();
//		}
//
...
//				    bias1 += (alpha * cost * deltaSigmoid * totalResults [j]);
//				}
...
//					    bias2 += (alpha * cost * deltaSigmoid * totalInputs [k] [j]);
//					}
...
//				}
//			    thisElement = sig(thisElement + bias1);
