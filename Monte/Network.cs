...
namespace Monte
{
    public class NetworkModel
    {
        ...
        public NetworkModel(){ parseXML("Assets/Monte/DefaultSettings.xml"); }
        public NetworkModel(string settingsFile, int flag){ parseXML(settingsFile); }
        public NetworkModel (string modelfile) : this(modelfile, "Assets/Monte/DefaultSettings.xml") {}
        public NetworkModel(string modelfile, string settingsFile)
        {
            parseModel((modelfile));
            parseXML(settingsFile);
        }

        public NetworkModel(double _alpha, int _maxItters, int _hiddenLayers)
        {
            alpha = _alpha;
